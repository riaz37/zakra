        ...
        {navOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute start-0 top-0 h-dvh w-56"
            >
              <div className="relative h-full">
                ...
                <button
                  ...
                  onClick={closeNav}
                  aria-label="Close navigation"
                  className="absolute end-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-surface-300 text-foreground shadow-ring transition-all duration-200 hover:text-error hover:shadow-focus focus-visible:text-error focus-visible:shadow-focus focus-visible:outline-none"
                >
