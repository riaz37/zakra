...
export function buildMarkdownComponents(
  ...
  const base: Components = {
    p: ({ children }) => (
      <p
        className={`mb-3 font-sans ${bodySize} leading-[1.7] text-foreground last:mb-0`}
      >
        {children}
      </p>
    ),
    ...
    li: ({ children }) => (
      <li
        className={`flex gap-2 font-sans ${bodySize} leading-[1.7] text-foreground`}
      >
        <span
          aria-hidden
...
export const markdownComponents: Components = buildMarkdownComponents();
